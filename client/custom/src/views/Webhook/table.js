...
Espo.define('views/Webhook/record/table', 'view', function (Dep) {

    return Dep.extend({
        template: 'Webhook/record/table',
        scopeList: null,
        ...
        setup: function () {
            ...
            this.template = 'webhook/table';
            if (this.mode == 'edit') {
                this.template = 'webhook/table-edit';
            }
        },
        setupData: function () {
            this.acl = {};
        ...
        showAddFieldModal: function (scope) {
            ...
            this.createView('addField', 'views/webhook/modals/add-field', {
                scope: scope,
